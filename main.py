...
F3.place(x=700,y=180,width=350,height=500)
...
btn5=Button(F2, text='Print', font='arial 15 bold', padx=5, pady=10,  bg='lime', width=7)
btn5.grid(row=4, column=5, padx=10, pady=30)
